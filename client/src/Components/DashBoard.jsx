  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      const res = await axios.put(
        `https://job-protal-1-bwud.onrender.com/api/applicants/${id}`,
        { status: newStatus }
      );
...
const fetchJobs = async () => {
  ...
  const fetchApplicants = async () => {
    try {
      const res = await axios.get("https://job-protal-1-bwud.onrender.com/api/applicants");
  ...
  const handleSaveJob = async () => {
    ...
    try {
      const res = await axios.post("https://job-protal-1-bwud.onrender.com/api/jobs", newJob);
  ...
  const handleUpdateJob = async () => {
    ...
    try {
      const res = await axios.put(
        `https://job-protal-1-bwud.onrender.com/api/jobs/${editId}`,
        newJob
      );
  ...
  const handleDeleteJob = async (id) => {
    ...
    try {
      await axios.delete(`https://job-protal-1-bwud.onrender.com/api/jobs/${id}`);
  ...
  const handleDeleteApplicant = async (id) => {
    ...
    try {
      await axios.delete(`https://job-protal-1-bwud.onrender.com/api/applicants/${id}`);
